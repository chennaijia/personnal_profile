<template>
    <div class="bg-blue py-4 mx-auto">
        <div class="w-full h-screen bg-[url(~/static/images/background.jpg)] bg-cover bg-center bg-fixed bg-no-repeat h-screen">
            ...
            <div class="flex flex-col">
                <div class="flex justify-between py-8 px-4 place-content-between">
                    <div class="mr-10">
                        ...
                        <p class="pt-4 text-xl text-gray-600 font-semibold">@naijia</p>
                    </div>
